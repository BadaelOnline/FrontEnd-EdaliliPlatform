<template>
    <div class="parent">
      ...
      <div class="card">
          <div class="date">
              <div @click="setDate('today')" :class="[dateStatus == 'today' ? 'active': '']">اليوم</div>
              <div @click="setDate('yesterday')" :class="[dateStatus == 'yesterday' ? 'active': '']">البارحة</div>
              <div @click="setDate('week')" :class="[dateStatus == 'week' ? 'active': '']">هذا الاسبوع</div>
              <div @click="setDate('month')" :class="[dateStatus == 'month' ? 'active': '']">هذا الشهر</div>
              <div @click="setDate('year')" :class="[dateStatus == 'year' ? 'active': '']">هذه السنة</div>
              <div @click="setDate('selectDate')" :class="[dateStatus == 'selectDate' ? 'active': '']">تاريخ محدد</div>
          </div>
          <div class="sales">
            <div>
                <h2>3</h2>
            ...
            <div>
                <h2>950.000 <span style="font-size:20px">ل.س</span></h2>
...
<div>من 5</div>
      ...
      <div class="rw2">
             <div><span>رقم الطلب</span></div>
             <div><span>المجموع</span></div>
             <div><span>الزبون</span></div>
             <div><span>التاريخ/الوقت</span></div>
             <div style="text-align: start;"><span>Action</span></div>
      </div>  
      <hr>
        <div class="rw2">
      ...
      <hr>
       <div class="rw2" 
        ...
        padding-bottom: 10px;">
            ...
            <div><span>User223355</span></div>
            <div><span>التاريخ/الوقت</span></div>
            <div><button class="but1">معلومات الطلب</button></div>
      </div>
            <div class="rw2" 
        style="margin-bottom: 10px;
        border-bottom: 1px solid #aaa;
      ...
      <div class="small-card">
          ...
          <div class="sales">
            ...
            <div>
                <h4>950.000 <span style="font-size:20px">ل.س</span></h4>
                <span>إجمالي المبيعات</span>
            </div>
          </div>
        <div class="action">
        ...
        <div class="orders">
            ...
            <div class="user">
                ...
                <i class="fa fa-user-circle" aria-hidden="true" style="margin-inline-end: 5px;"></i>
...
font-size: 12px;"></i>
            ...
            <div class="content">
                ...
                <div>
                   <button class="but1">معلومات الطلب</button>
                </div>
            </div>
        </div>
               <!-- order 2 -->
