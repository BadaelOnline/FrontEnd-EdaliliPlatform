...
<div>من 5</div>
      ...
      <div class="rw2">
             ...
             <div><span>الحالة</span></div>
             <div><span>الاعدادات</span></div>
      </div>  
      <hr>
       <div class="rw2" 
        ...
        padding-bottom: 10px;">
            <div>طريقة التوصيل 1</div>
            <div><span class="aprrov">مفعلة</span></div>
            <div><button class="but1">تعديل</button></div>
      </div>
            <div class="rw2" 
        style="margin-bottom: 10px;
        border-bottom: 1px solid #aaa;
        padding-bottom: 10px;">
            <div>طريقة التوصيل 2</div>
            <div><span class="aprrov">مفعلة</span></div>
            <div><button class="but1">تعديل</button></div>
      </div>
             <div class="rw2">
            <div>طريقة التوصيل 3</div>
            <div><span class="notaprrov">غير مفعلة</span></div>
            <div><button class="but1">تعديل</button></div>
      </div>
