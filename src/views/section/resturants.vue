<template>
    ...
    <input type="input" class="form__field"  name="search" id='name'   v-model="search" required />
 ...
 <img src="../../../public/img/spoon.png" style="width: 200px;"> 
            ...
            <div v-if="filterSearch.length > 0" class="top_title">                    
                ...
                <h2> <i class="fas fa-exclamation-triangle" style="margin: 0 30px"></i>No Result Founded</h2>
