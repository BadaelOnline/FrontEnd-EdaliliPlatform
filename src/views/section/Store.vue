<template>
    <div class="contian">
        <div class="board">
            <div class="form__group field">
                <input
                    ...
                    required
                />
                <label for="name" class="form__label">Search Stores</label>
            </div>
        </div>
        <!-- <div class="child3">
            ...
            <div class="side" id="side">
                <div class="screen">
                    ...
                    <div
                        ...
                        :key="section.id"
                    >
                        <input name="dot" type="checkbox" class="dot" />
                        <label class="dot">
        ...
        <!-- <div class="img_boarder">
            <br />
            <img src="../../../public/img/store.png" style="width: 200px" />
        </div> -->
        ...
        <div
            ...
            v-for="store in filterSearch.slice(0, 1)"
            :key="store.id"
            :store="store"
            data-aos="fade-up"
            data-aos-offset="200"
...
export default {
    ...
    computed: {
        ...mapState(['categories', 'Stores', 'Sections']),
        filterSearch() {
...
.store .card {
    ...
    display: flex;
    flex-direction: row;
    background: linear-gradient(0.25turn, #bbd2c5, #7a7d80);
    color: #fff;
    text-align: center;
    padding: 2em;
}
