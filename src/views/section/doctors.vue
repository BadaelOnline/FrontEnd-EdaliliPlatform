...
<ul>
  ...
  <ol>
    <li class="menu-item">
      ...
      <ol class="sub-menu">
       <li class="menu-item item--a"><a href="#0" class="item--a"><span>أسنان</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--b"><span>أوعية دموية</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--c"><span>قلبية</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--c"><span>أطفال</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--c"><span>بولية</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--c"><span>نسائية</span></a></li>
        <li class="menu-item item--b"><a href="#0" class="item--c"><span>تجميلية</span></a></li>
      </ol>
    </li>
        <li class="menu-item">
      <a href="#0" class="kabo">
      ...
      <ol class="sub-menu">
        <li class="menu-item"><a href="#0" class="item--a"><span>مشافي خاصة</span></a></li>
        <li class="menu-item"><a href="#0" class="item--b"><span>وطنية مشافي</span></a></li> 
      </ol>
    </li>
    <li class="menu-item">
...
/*________________________ hospital _______________________ */
.attribution { 
...
//  _______________ start heart _________________
.heart {
  background-color: #009b9e;
  width: 50px;
  height: 50px;
...
//  _______________ end heart _________________
ol {
    list-style: none;
    padding: 0;
    margin: 0;
